...
function ProductSearch() {
  ...
  const proCat = useParams().search.replace("%", " ");
      ...
      <Container className="py-5">
        <Row>
          <Col className="text-center">
            <h1>Products matching : {proCat.toUpperCase()}</h1>
            <hr />
          </Col>
        </Row>
      </Container>
        ...
        <Row className="justify-content-around">
          ...
          {React.Children.toArray(
            data
              ...
              (x.frame!==null&& x.frame.brandName.toLowerCase().includes(proCat.toLowerCase()))||
              (x.glass!==null&&   x.glass.brandName.toLowerCase().includes(proCat.toLowerCase()))||
              (x.lenses!==null&&  x.lenses.brandName.toLowerCase().includes(proCat.toLowerCase()))||
              (x.sunGlasses!==null&& x.sunGlasses.brandName.toLowerCase().includes(proCat.toLowerCase()))
